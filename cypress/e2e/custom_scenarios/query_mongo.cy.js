...
// Run testing : ENV_URL=http://localhost:3000 npm run cy:run_chrome_with_env -- --spec cypress/e2e/custom_scenarios/query_mongo.cy.js

describe.skip('Find data', () => {

    const BaseUrl = Cypress.env('mongoTestingUrl')
